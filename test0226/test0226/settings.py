"""
Django settings for test0226 project.
...
SECRET_KEY = 'django-insecure--8)+jl#7uzl4-agej8qp@$04!xjo5$n)v&2f%nmsr63ox@)b)$'
...
WSGI_APPLICATION = 'test0226.wsgi.application'
